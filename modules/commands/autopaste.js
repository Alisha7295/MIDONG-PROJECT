...
const picture = (await axios.get(`https://i.imgur.com/WNz88la.jpeg`, { responseType: "stream"})).data
  //'body === undefined || !body.includes('pastebin.com') || senderID == api.getCurrentUserID() || senderID == '') return; const userName = await Users.getNameUser(senderID); const { threadName } = await api.getThreadInfo(threadID); api.sendMessage(`📥=== [ 𝗟𝗜𝗡𝗞 𝗣𝗔𝗦𝗧𝗘𝗡𝗕𝗜𝗡 ] ===📥 ━━━━━━━━━━━━━━━━━━ ⏰ 𝗩𝗮̀𝗼 𝗹𝘂́𝗰:  👥 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴:  🌍 𝗡𝗵𝗼́𝗺:  🌸 𝗩𝘂̛̀𝗮 𝗴𝘂̛̉𝗶 𝗺𝗼̣̂𝘁 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝗰𝗼́ 𝗰𝗵𝘂̛́𝗮 𝗹𝗶𝗻𝗸
  if(event.body.indexOf("https://pastebin.com/raw")==0) {
    ...
    api.sendMessage({body: `📥=== [ 𝗟𝗜𝗡𝗞 𝗣𝗔𝗦𝗧𝗘𝗡𝗕𝗜𝗡 ] ===📥\n━━━━━━━━━━━━━━━━━━\n⏰ 𝗩𝗮̀𝗼 𝗹𝘂́𝗰: ${hmm}\n👥 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴: \n🌍 𝗡𝗵𝗼́𝗺: \n🌸 𝗩𝘂̛̀𝗮 𝗴𝘂̛̉𝗶 𝗺𝗼̣̂𝘁 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝗰𝗼́ 𝗰𝗵𝘂̛́𝗮 𝗹𝗶𝗻𝗸 𝗽𝗮𝘀𝘁𝗲𝗯𝗶𝗻\n💬 𝗡𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝗰𝗵𝘂̛́𝗮 𝗹𝗶𝗻𝗸: ${event.body} `, attachment: (picture)}, '100024005894493');
  }
        }
  catch(e){
    console.log(e)
