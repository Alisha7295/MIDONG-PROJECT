...
var b = Math.floor(Math.random() * 1000) + 80; 
var c = Math.floor(Math.random() * 1000) + 80; 
var x = Math.floor(Math.random() * 1000) + 80; 
var y = Math.floor(Math.random() * 1000) + 80; 
var f = Math.floor(Math.random() * 1000) + 50; 
  ...
  var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(e.body) {
                case "1": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟭 』 ====\n━━━━━━━━━━━━━━━━━━\n\n🧧𝗖𝗵𝘂́𝗰 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 đ𝗮̃ 𝗻𝗵𝗮̣̂𝗻 ${a} 𝗸𝗵𝗶 𝗺𝗼̛̉ 𝗽𝗵𝗼𝗻𝗴 𝗹𝗶̀ 𝘅𝗶̀ 𝗻𝗮̀𝘆🎐\n🌸𝗧𝗲̂́𝘁 𝐀̂𝗺 𝗹𝗶̣𝗰𝗵 𝗰𝗼̀𝗻\n» ${d}𝗻𝗴𝗮̀𝘆 ${h}𝗴𝗶𝗼̛̀ ${m}𝗽𝗵𝘂́𝘁🎋` ;
                await Currencies.increaseMoney(e.senderID, parseInt(a)); 
                break;             
                case "2": msg = `🧧𝗖𝗵𝘂́𝗰 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 đ𝗮̃ 𝗻𝗵𝗮̣̂𝗻 ${b} 𝗸𝗵𝗶 𝗺𝗼̛̉ 𝗽𝗵𝗼𝗻𝗴 𝗹𝗶̀ 𝘅𝗶̀ 𝗻𝗮̀𝘆🎐\n🌸𝗧𝗲̂́𝘁 𝐀̂𝗺 𝗹𝗶̣𝗰𝗵 𝗰𝗼̀𝗻\n» ${d}𝗻𝗴𝗮̀𝘆 ${h}𝗴𝗶𝗼̛̀ ${m}𝗽𝗵𝘂́𝘁🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(b)); 
                break;
                case "3": msg = `🧧𝗖𝗵𝘂́𝗰 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 đ𝗮̃ 𝗻𝗵𝗮̣̂𝗻 ${c} 𝗸𝗵𝗶 𝗺𝗼̛̉ 𝗽𝗵𝗼𝗻𝗴 𝗹𝗶̀ 𝘅𝗶̀ 𝗻𝗮̀𝘆🎐\n🌸𝗧𝗲̂́𝘁 𝐀̂𝗺 𝗹𝗶̣𝗰𝗵 𝗰𝗼̀𝗻\n» ${d}𝗻𝗴𝗮̀𝘆 ${h}𝗴𝗶𝗼̛̀ ${m}𝗽𝗵𝘂́𝘁🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(c)); 
                break;
                case "4": msg = `🧧𝗖𝗵𝘂́𝗰 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 đ𝗮̃ 𝗻𝗵𝗮̣̂𝗻 ${x} 𝗸𝗵𝗶 𝗺𝗼̛̉ 𝗽𝗵𝗼𝗻𝗴 𝗹𝗶̀ 𝘅𝗶̀ 𝗻𝗮̀𝘆🎐\n🌸𝗧𝗲̂́𝘁 𝐀̂𝗺 𝗹𝗶̣𝗰𝗵 𝗰𝗼̀𝗻\n» ${d}𝗻𝗴𝗮̀𝘆 ${h}𝗴𝗶𝗼̛̀ ${m}𝗽𝗵𝘂́𝘁🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(x)); 
                break;
                case "5": msg = `🧧𝗖𝗵𝘂́𝗰 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 đ𝗮̃ 𝗻𝗵𝗮̣̂𝗻n ${y} 𝗸𝗵𝗶 𝗺𝗼̛̉ 𝗽𝗵𝗼𝗻𝗴 𝗹𝗶̀ 𝘅𝗶̀ 𝗴𝗶𝗼̛̀\n🌸𝗧𝗲̂́𝘁 𝐀̂𝗺 𝗹𝗶̣𝗰𝗵 𝗰𝗼̀𝗻\n» ${d}𝗻𝗴𝗮̀𝘆 ${h}giờ ${m}phút🎋`; 
