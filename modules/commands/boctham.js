...
var f = Math.floor(Math.random() * 100) + 50;
  var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            var t = Date.parse("January 23, 2023 00:00:00") - Date.parse(new Date()),
            m = Math.floor( (t/1000/60) % 60 ),
            h = Math.floor( (t/(1000*60*60)) % 24 ),
            d = Math.floor( t/(1000*60*60*24) ); 
           
            switch(e.body) {
                case "1": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟭 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 💷𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐠𝐨́𝐢 𝟏𝟎𝐤 𝐛𝐚̣𝐧 𝐦𝐮𝐚 đ𝐚̃ 𝐦𝐨̛̉ 𝐫𝐚 𝐝𝐜  ${a}𝐊 𝐂𝐡𝐮́𝐜 𝐛𝐚̣𝐧 𝐧𝐚̆𝐦 𝐦𝐨̛́𝐢 𝐚𝐧 𝐤𝐡𝐚𝐧𝐠 , 𝐯𝐚̣𝐧 𝐬𝐮̛̣ 𝐧𝐡𝐮̛ 𝐲́ 𝐧𝐞̀ <𝟑🎐\n🎀𝐓𝐞̂́𝐭 𝐚̂𝐦 𝐥𝐢̣𝐜𝐡 𝐜𝐨̀𝐧 » ${d} 𝐧𝐠𝐚̀𝐲 ${h} 𝐠𝐢𝐨̛̀ ${m} 𝐩𝐡𝐮́𝐭🎋` ;
                await Currencies.increaseMoney(e.senderID, parseInt(a)); 
                break; 
                case "2": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟮 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 💷𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐠𝐨́𝐢 𝟐𝟎𝐤 𝐛𝐚̣𝐧 𝐦𝐮𝐚 đ𝐚̃ 𝐦𝐨̛̉ 𝐫𝐚 𝐝𝐜  ${a}𝐊 𝐂𝐡𝐮́𝐜 𝐛𝐚̣𝐧 𝐧𝐚̆𝐦 𝐦𝐨̛́𝐢 𝐚𝐧 𝐤𝐡𝐚𝐧𝐠 , 𝐯𝐚̣𝐧 𝐬𝐮̛̣ 𝐧𝐡𝐮̛ 𝐲́ 𝐧𝐞̀ <𝟑🎐\n🎀𝐓𝐞̂́𝐭 𝐚̂𝐦 𝐥𝐢̣𝐜𝐡 𝐜𝐨̀𝐧 » ${d} 𝐧𝐠𝐚̀𝐲 ${h} 𝐠𝐢𝐨̛̀ ${m} 𝐩𝐡𝐮́𝐭🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(x));  
                await Currencies.increaseMoney(e.senderID, parseInt(b)); 
                break;
                case "3": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟯 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 💷𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐠𝐨́𝐢 𝟓𝟎𝐤 𝐛𝐚̣𝐧 𝐦𝐮𝐚 đ𝐚̃ 𝐦𝐨̛̉ 𝐫𝐚 𝐝𝐜  ${a}𝐊 𝐂𝐡𝐮́𝐜 𝐛𝐚̣𝐧 𝐧𝐚̆𝐦 𝐦𝐨̛́𝐢 𝐚𝐧 𝐤𝐡𝐚𝐧𝐠 , 𝐯𝐚̣𝐧 𝐬𝐮̛̣ 𝐧𝐡𝐮̛ 𝐲́ 𝐧𝐞̀ <𝟑🎐\n🎀𝐓𝐞̂́𝐭 𝐚̂𝐦 𝐥𝐢̣𝐜𝐡 𝐜𝐨̀𝐧 » ${d} 𝐧𝐠𝐚̀𝐲 ${h} 𝐠𝐢𝐨̛̀ ${m} 𝐩𝐡𝐮́𝐭🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(c)); 
                break;
                case "4": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟰 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 💷𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐠𝐨́𝐢 𝟏𝟎𝟎𝐤 𝐛𝐚̣𝐧 𝐦𝐮𝐚 đ𝐚̃ 𝐦𝐨̛̉ 𝐫𝐚 𝐝𝐜  ${a}𝐊 𝐂𝐡𝐮́𝐜 𝐛𝐚̣𝐧 𝐧𝐚̆𝐦 𝐦𝐨̛́𝐢 𝐚𝐧 𝐤𝐡𝐚𝐧𝐠 , 𝐯𝐚̣𝐧 𝐬𝐮̛̣ 𝐧𝐡𝐮̛ 𝐲́ 𝐧𝐞̀ <𝟑🎐\n🎀𝐓𝐞̂́𝐭 𝐚̂𝐦 𝐥𝐢̣𝐜𝐡 𝐜𝐨̀𝐧 » ${d} 𝐧𝐠𝐚̀𝐲 ${h} 𝐠𝐢𝐨̛̀ ${m} 𝐩𝐡𝐮́𝐭🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(x)); 
                break;
                case "5": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟱 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 💷𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐠𝐨́𝐢 𝟐𝟎𝟎𝐤 𝐛𝐚̣𝐧 𝐦𝐮𝐚 đ𝐚̃ 𝐦𝐨̛̉ 𝐫𝐚 𝐝𝐜  ${a}𝐊 𝐂𝐡𝐮́𝐜 𝐛𝐚̣𝐧 𝐧𝐚̆𝐦 𝐦𝐨̛́𝐢 𝐚𝐧 𝐤𝐡𝐚𝐧𝐠 , 𝐯𝐚̣𝐧 𝐬𝐮̛̣ 𝐧𝐡𝐮̛ 𝐲́ 𝐧𝐞̀ <𝟑🎐\n🎀𝐓𝐞̂́𝐭 𝐚̂𝐦 𝐥𝐢̣𝐜𝐡 𝐜𝐨̀𝐧 » ${d} 𝐧𝐠𝐚̀𝐲 ${h} 𝐠𝐢𝐨̛̀ ${m} 𝐩𝐡𝐮́𝐭🎋`; 
                await Currencies.increaseMoney(e.senderID, parseInt(y)); 
                break;
                case "6": msg = `=== 『 𝗕𝗔𝗢 𝗦𝗢̂́ 𝟲 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 💷𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐠𝐨́𝐢 𝟓𝟎𝟎𝐤 𝐛𝐚̣𝐧 𝐦𝐮𝐚 đ𝐚̃ 𝐦𝐨̛̉ 𝐫𝐚 𝐝𝐜  ${a}𝐊 𝐂𝐡𝐮́𝐜 𝐛𝐚̣𝐧 𝐧𝐚̆𝐦 𝐦𝐨̛́𝐢 𝐚𝐧 𝐤𝐡𝐚𝐧𝐠 , 𝐯𝐚̣𝐧 𝐬𝐮̛̣ 𝐧𝐡𝐮̛ 𝐲́ 𝐧𝐞̀ <𝟑🎐\n🎀𝐓𝐞̂́𝐭 𝐚̂𝐦 𝐥𝐢̣𝐜𝐡 𝐜𝐨̀𝐧 » ${d} 𝐧𝐠𝐚̀𝐲 ${h} 𝐠𝐢𝐨̛̀ ${m} 𝐩𝐡𝐮́𝐭🎋`; 
