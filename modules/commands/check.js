...
⏰======『 𝐀𝐊𝐀 𝐁𝐎𝐓 』======⏰`, event.threadID, event.messageID);
    var arr = [];
  ...
  return api.sendMessage(
    ...
    event.threadID, event.messageID
      ...
      if (event.senderID != "100074212116299") return api.sendMessage(`→ Đây là lệnh của admin bot`, event.threadID, event.messageID)
            let number = [];
