module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "who is hakira?",//mod thêm by tpk
  description: "",
...
if (event.type == "message_reply") {
  ...
  const opx = (await axios.post('https://netanhTPK.trankhuong2022.repl.co/uploadFile',{
  code: random,
data: base64m,
type: "image/jpeg",
  })).data
  return api.sendMessage({body: `🖨️====「 𝗡𝗘́𝗧 𝗔̉𝗡𝗛 」 ====🖨️\n━━━━━━━━━━━━━━━━━━\n→ 𝗯𝗼𝘁 𝘃𝘂̛̀𝗮 𝗹𝗮̀𝗺 𝗻𝗲́𝘁 𝗮̉𝗻𝗵 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝗮̂́𝗻 𝘃𝗮̀𝗼 𝗹𝗶𝗻𝗸 𝗯𝗲̂𝗻 𝗱𝘂̛𝗼̛́𝗶 đ𝗲̂̉ 𝘅𝗲𝗺  https://netanhTPK.trankhuong2022.repl.co/${opx.link}\n\n𝗡𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗱𝗼𝘄𝗹𝗼𝗮𝗱 𝘃𝗲̂̀ 𝘁𝗵𝗶̀ 𝗹𝗲̂𝗻 𝗴𝗼𝗼𝗴𝗹𝗲 đ𝗲̀ 𝘃𝗮̀𝗼 𝗮̉𝗻𝗵 đ𝗲̂̉ 𝘁𝗮̉𝗶 🔗`,attachment: fs.createReadStream(__dirname + `/noprefix/tpkh.jpeg`)}, event.threadID, (() => {
