...
module.exports.run = async ({ api, event, args, getText, Users }) => {
  const permission = ["","","100054416075122"]; //nếu muốn thêm uid thì thêm ,"uid" sau mỗi hàng
             if (!permission.includes(event.senderID))
             return api.sendMessage("[❗] ➝ 𝐇𝐢𝐞̣̂𝐧 𝐓𝐚̣𝐢 𝐁𝐚̣𝐧 𝐊𝐡𝐨̂𝐧𝐠 𝐂𝐨́ 𝐐𝐮𝐲𝐞̂̀𝐧 𝐒𝐮̛̉ 𝐃𝐮̣𝐧𝐠 [ tb ]\n• 𝐍𝐚̂𝐧𝐠 𝐐𝐮𝐲𝐞̂̀𝐧 𝐇𝐚̣𝐧 𝐋𝐢𝐞̂𝐧 𝐇𝐞̣̂ 𝐀𝐝𝐦𝐢𝐧 !!!\n• 𝐅𝐁   ➝ https://www.facebook.com/sadboy.ducryo", event.threadID, event.messageID); // get tn
