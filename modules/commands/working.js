...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "work.png")) request("https://imgur.com/VAvsY5E.mp4").pipe(fs.createWriteStream(dirMaterial + "work.mp4"));
}
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(e.body) {
                ...
                break;
                attachment: fs.createReadStream(__dirname + `/cache/work.mp4`)
                default: break;
            };
